...
def main(params):
  ...
  for i,img in enumerate(imgs):
    ...
    # print("params['images_root']",params['images_root'])
...
if __name__ == "__main__":
  ...
  parser.add_argument('--images_root', default='data/ai_challenger', help='root location in which images are stored, to be prepended to file_path in input json')
